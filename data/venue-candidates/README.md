...
Routine runs should validate candidate JSON against `schema.json` before opening a PR. If validation fails, the routine should write `YYYY-MM-DD_ERROR.md` instead of proposing registry rows.
