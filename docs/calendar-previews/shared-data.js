// Shared sample data for the HTML calendar previews (kept deliberately small + deterministic).
// Not used by the app; this is only for docs mockups.
...
export function byDay(dayKey){
  return events.filter(e => e.day === dayKey).sort((a,b) => a.start.localeCompare(b.start));
}
