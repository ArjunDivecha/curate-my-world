// Shared sample data for the HTML calendar previews.
// This file intentionally avoids ES module syntax so it works over file://.
//
// Access as: window.CalendarPreviewData
...
(function () {
  ...
  window.CalendarPreviewData = { CAT, WEEK, events, byDay, hhmmToMinutes };
})();
