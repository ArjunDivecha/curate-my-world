...
description: Weekly Squirtle venue discovery rules for the svda-weekly Claude Code Routine. Use when proposing new Bay Area venue registry rows from web research.
---
...
Run weekly inside the `svda-weekly` Claude Code Routine to propose new Bay Area venues for Squirtle. The routine must create a PR, not push to `main`.
